...
void loadExternalTextures() {
	BitMapFile* image[15];
	image[0] = getBmp("asserts/rock.bmp");
	image[1] = getBmp("asserts/wood_floor.bmp");
	image[2] = getBmp("asserts/hay.bmp");
	image[3] = getBmp("asserts/granite.bmp");
	image[4] = getBmp("asserts/ground.bmp");
	image[5] = getBmp("asserts/wood.bmp");
	image[6] = getBmp("asserts/wall4.bmp");
	image[7] = getBmp("asserts/crops.bmp");
	image[8] = getBmp("asserts/woodenBox.bmp");
	image[9] = getBmp("asserts/grass_ground.bmp");
	image[10] = getBmp("asserts/floor.bmp");
	image[11] = getBmp("asserts/door.bmp");
	image[12] = getBmp("asserts/win.bmp");
	image[13] = getBmp("asserts/feather1.bmp");
	image[14] = getBmp("asserts/feather2.bmp");
